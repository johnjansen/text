# An implementation of the Metaphone phonetic coding system in Crystal.
#
...
module Text
  module Metaphone
    ...
    private def metaphone_word(w, options : Hash(::String, ::String) = Hash(::String, ::String).new )
      ...
      rules.each { |(rx, rep)| s = s.gsub(rx, rep) }
      return s.upcase
    end
  end
end